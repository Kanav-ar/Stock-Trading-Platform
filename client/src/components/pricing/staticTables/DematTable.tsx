...
export default function DematTable() {
  return (
    <>
      ...
      <div className="inline bg-blue-100 py-2 px-6 rounded-r max-w-xs border-[#387ed1] border-l-4 dark:border-blue-600 dark:bg-blue-200 dark:text-black">Free for first year*</div>
