...
const TopBar = () => {
  return (
    <header className="flex h-16 md:h-[10vh] w-full items-center bg-white shadow-[0_0_4px_2px_rgb(236,235,235)] transition-colors dark:bg-[#070d17] dark:shadow-none dark:border-b dark:border-gray-700">
      <div
        className="
          hidden
          lg:flex
